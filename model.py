...
class Tutor(User):
    ...
    def add_offer(self, offer):
        ...
        self.offers.append(
            Offer(offer['bidId'], offer['initiatorId'], offer['date_created'], date_and_time, offer['sesPerWeek'],
        ...
        if 'offers' in additional_info:
            ...
            for offer in additional_info['offers']:
                if 'contractLen' in offer:
                    ...
                    contract_len = 0
                o = Offer(offer['bidId'], offer['initiatorId'], offer['date_created'], offer['dayAndTime'],
