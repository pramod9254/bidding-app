...
class User_API_access(API_access_patch_get_by_id):
    ...
    def get_all_users(self):
        ...
        print('get_all_users user---- ', url)
        # data = super().get_all(url)
        data = ResponseData().getUsers()
        print('get_all_users user---- ', data)
        return data
    ...
    def verify_login(self, username, password):
        ...
        print('users_login_url------', users_login_url)
        ...
        return 1==1  #//format(self.response.reason) == 'OK'
...
class Subject_API_access(API_access_add_new):
    ...
    def get_all_subjects(self):
        ...
        return ResponseData().getSubjects()
...
class Contract_API_access(API_access_add_new):
    ...
    def get_all_contracts(self):
        ...
        return ResponseData().getContracts()
    ...
    def reformat_additional_info(self, info_to_reformat):
        ...
        for i in range(len(info_to_reformat['offers'])):
            offer_format = {
                ...
                'date_created': info_to_reformat['offers'][i].get_date_created(),
        ...
        updated_info = {
            'additional_info': additional_info_format
        }
        return updated_info
