...
class ProfileView(Page):
    def __init__(self, user, controller, initialisation):
        ...
        if True:
            y += 50
            self.bid_button = Button(text="Pending Offers", bg='#f244aa', font=("Arial", 14), fg='black', width="20",
        ...
        if isinstance(user, Student):
            y += 50
            self.bid_button = Button(text="Pending Bids", bg='#f244aa', font=("Arial", 14), fg='black', width="20",
                                     command=lambda: self.controller.bids_list_btn(self))
            self.bid_button.place(x=320, y=y)
...
class CreateBidView(Page):
    def __init__(self, controller, type_bid):
        ...
        self.submit_button = Button(text="Submit", bg="#BFA2F7", font=("Arial", 14), fg='black', width="20",
                                    command=lambda: self.controller.submit_form(bid_info, lesson_info, self, ))
        self.submit_button.place(x=400, y=480)
...
class BidInfoView(Page):
    def __init__(self, controller, user, bid, initiators, is_monitor):
        ...
        # Back button
        self.back_button = Button(text="Back", bg='#aec6cf', font=("Arial", 14), fg='black', width="20",
        ...
        if not found:
            if isinstance(self.user, Tutor):
                if isinstance(self.bid, OpenBid):
                    self.buy_out_button = Button(text="Buy out", bg='#d152ff', font=("Arial", 14), fg='black',
                                                 width="10",
                                                 command=lambda: self.controller.buy_out_btn(self))
                    self.buy_out_button.place(x=280, y=40)

                    # Add to favourites button
                    self.back_button = Button(text="Add to monitor", bg='#990099', font=("Arial", 14), fg='black',
                                              width="12",
                                              command=lambda: self.controller.monitor_btn())
                    self.back_button.place(x=580, y=40)

                self.contract_button = Button(text="Make an offer", bg='#5c3f8f', font=("Arial", 14), fg='black',
...
class OfferInfoView(Page):
    def __init__(self, controller, offer, initiator, user, bid):
        ...
        if isinstance(self.user, Student):
            if isinstance(self.bid, OpenBid):
                self.accept_button = Button(text="Accept", bg='#77dd77', font=("Arial", 14), fg='black', width=20,
                                            command=lambda: self.controller.accept_btn(self))
                self.accept_button.place(x=130, y=y)
                self.decline_button = Button(text="Decline", bg='#ff6961', font=("Arial", 14), fg='black', width=20,
                                             command=lambda: self.controller.decline_btn(self))
                self.decline_button.place(x=400, y=y)
            else:
                self.accept_button = Button(text="Accept", bg='#77dd77', font=("Arial", 14), fg='black', width=13,
                                            command=lambda: self.controller.accept_btn(self))
                self.accept_button.place(x=130, y=y)
                self.decline_button = Button(text="Decline", bg='#ff6961', font=("Arial", 14), fg='black', width=13,
                                             command=lambda: self.controller.decline_btn(self))
                self.decline_button.place(x=300, y=y)
                self.chat_button = Button(text="Chat", bg="#BFA2F7", font=("Arial", 14), fg='black', width=13,
    ...
    def __init__(self, controller, contract, user):
        ...
        if isinstance(user, Student):
            if contract.get_expiry_date() <= datetime.now().isoformat()[:-3] + 'Z':
                ...
                self.reuse_button = Button(text="Reuse \nContract", bg='#f244aa', font=("Arial", 14), fg='black',
...
class ChatView(Page):
    def __init__(self, controller, opponent_username):
        ...
        # Back button
        # Creating back button
        self.back_button = Button(text="Back", bg='#aec6cf', font=("Arial", 14), fg='black',
                                  width="20",
        ...
        self.send_button = Button(self.root, width="12", text="Send", bg='#5c3f8f', fg='black', font=("Arial", 14),
