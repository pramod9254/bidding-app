from logic import User2, Student, UserAdapter, LoginMechanism, BidAdapter, BidCreator, ContractCreator, OfferAdapter, \
    Chat, MessagesAdapter, CloseDownBid, ContractAdapter, BidUpdater, ContractsSort
from view import LoginView, SignUpView, ProfileView, ProfileView1, ChatView, BidsListView, ChooseBidView, CreateBidView, \
    BidInfoView, CreateOfferView, OfferInfoView, ContractInfoView, ContractsListView, END, NORMAL, DISABLED, \
    ChooseNewContractView, ReuseContractView, BuyerBidsListView, CreateBidView2, BidsList2View, ContractsList2View, NewTermsContractView, ChooseTutorForContractView
...
class LoginController:
    ...
    def login_btn(self, username, password, login):
        ...
        print('varifies user------', verified_user)
...
class BidsList2Controller:
    ...
    def approve_bid_btn(self, view, selected_bid):
        print('approve_bid_btn------', selected_bid)
        contract = {
...
class BuyerBidsList2Controller:
    def __init__(self, user):
        self.user = user
        ...
        BuyerBidsListView(self, self.bids, self.user)

    def action_bid_btn(self, view):
        """
        Inputs:
            - view: instance of the BidsListView page
        Return: None
...
class BidsListController:
    ...
    def __init__(self, user):
        ...
        if isinstance(self.user, Student):
            print('self.user.get_id()------', self.user.get_id())
...
class CreateOfferController:
    ...
    def submit_form(self, offer_info, view):
        ...
        offer = {
            ...
            'date_created': date_created_isoformat,
